...
public class calculator extends javax.swing.JFrame {
    ...
    switch(calculation){
        case 1 :  // addition
            ans= num1 + Double.parseDouble(DisplayField.getText());
            DisplayField.setText(Double.toString(ans));
            break;
        case 2 :    // subtraction 
            ans= num1 - Double.parseDouble(DisplayField.getText()); // convert string to double 
            DisplayField.setText(Double.toString(ans));
            break;
...
//    public void symbToNum(){
//        switch(symb){
//            case 1 :  // E
//            if(DisplayField.getText().contains("E")){
//               DisplayField.getText().replace("E",Double.toString(Math.E));
//            }
//            break;
//            }
//    }
    ...
    private void initComponents() {
        ...
        normalMenu = new javax.swing.JMenuItem();
        scientificMenu = new javax.swing.JMenuItem();
        ...
        normalMenu.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        normalMenu.setText("Normal");
        normalMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                normalMenuActionPerformed(evt);
            }
        });
        jMenu1.add(normalMenu);

        scientificMenu.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S, java.awt.event.InputEvent.CTRL_DOWN_MASK));
    ...
    private void scientificMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_scientificMenuActionPerformed
        ...
        this.setSize(501, 347);
        DisplayField.setSize(489,47);
    }//GEN-LAST:event_scientificMenuActionPerformed

    private void normalMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_normalMenuActionPerformed
        this.setResizable(false);
        this.setSize(246, 347); 
        //DisplayField.setSize(234,47);
    }//GEN-LAST:event_normalMenuActionPerformed
...
//        DisplayField.setText(DisplayField.getText() +"E");         
    ...
    private void Equal_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Equal_ActionPerformed
        jLabel1.setText(jLabel1.getText() + DisplayField.getText());
    ...
    private javax.swing.JMenuItem normalMenu;
    private javax.swing.JMenuItem scientificMenu;
